...
#    return hcat(0, 0)    
        ...
        - one(R) .* complex_multiply_SMatrix(
            SMatrix{1,2}(zero(R), one(R)), complex_multiply_SMatrix(
                SMatrix{1,2}(k1_r, k1_i), complex_multiply_SMatrix(
                    SMatrix{1,2}(k2_r, k2_i), J_mn_m_n__SeparateRealImag(m, n, m_, n_, k1_r, k1_i, k2_r, k2_i, r_array, θ_array, ϕ_array, n̂_array, kind, J_superscript_1, rotationally_symmetric)
                )
            )
        )
        ...
        - one(R) .* complex_multiply_SMatrix(
            SMatrix{1,2}(zero(R), one(R)), complex_multiply_SMatrix(
                SMatrix{1,2}(k1_r, k1_i), complex_multiply_SMatrix(
                    SMatrix{1,2}(k1_r, k1_i), J_mn_m_n__SeparateRealImag(m, n, m_, n_, k1_r, k1_i, k2_r, k2_i, r_array, θ_array, ϕ_array, n̂_array, kind, J_superscript_2, rotationally_symmetric)
                )
            )
        )
    )    
...
function Q_matrix_SeparateRealImag_SMatrix(
    ...
    m, n, m_, n_ = get_m_n_m__n__matrices_for_T_matrix(n_max)    
    Q_mn_m_n_11 = Q_mn_m_n_SeparateRealImag_SMatrix.(m, n, m_, n_, k1_r, k1_i, k2_r, k2_i, [r_array], [θ_array], [ϕ_array], [n̂_array], kind, 11, rotationally_symmetric, symmetric_about_plane_perpendicular_z)
    Q_mn_m_n_12 = Q_mn_m_n_SeparateRealImag_SMatrix.(m, n, m_, n_, k1_r, k1_i, k2_r, k2_i, [r_array], [θ_array], [ϕ_array], [n̂_array], kind, 12, rotationally_symmetric, symmetric_about_plane_perpendicular_z)
    Q_mn_m_n_21 = Q_mn_m_n_SeparateRealImag_SMatrix.(m, n, m_, n_, k1_r, k1_i, k2_r, k2_i, [r_array], [θ_array], [ϕ_array], [n̂_array], kind, 21, rotationally_symmetric, symmetric_about_plane_perpendicular_z)
    Q_mn_m_n_22 = Q_mn_m_n_SeparateRealImag_SMatrix.(m, n, m_, n_, k1_r, k1_i, k2_r, k2_i, [r_array], [θ_array], [ϕ_array], [n̂_array], kind, 22, rotationally_symmetric, symmetric_about_plane_perpendicular_z)
